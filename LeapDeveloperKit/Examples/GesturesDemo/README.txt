...
We created this sample using the Cinder cross-platform C++ library for its
...
packages for Windows and Mac OS X can be downloaded from
http://libcinder.org/releases/cinder_0.8.4_vc2010.zip and
http://libcinder.org/releases/cinder_0.8.4_mac.zip, respectively. GesturesDemo
will not build out of the box on Cinder 0.8.5 or later.
